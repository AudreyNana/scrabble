...
from tp4.nomJoueurVideException import NomJoueurVideException
...
class Joueur:
    ...
    def __init__(self, nom):
        ...
        # Exception pour le nom du joueur vide
        if nom.strip() == '':
            raise NomJoueurVideException('Le nom doit être non vide.')
